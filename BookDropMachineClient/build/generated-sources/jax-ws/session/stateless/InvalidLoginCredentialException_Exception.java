 ...
 * 
 */
@WebFault(name = "InvalidLoginCredentialException", targetNamespace = "http://stateless.session/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: session.stateless.InvalidLoginCredentialException
     */
